...
const sitename = "SSR Cloud";                    //站点名称  ⇦需要修改
const site = "https://ssrcloud.org/auth/login";    //站点首页  ⇦需要修改
const email = "wangyuanxi1012@gmail.com";        //登录邮箱  ⇦需要修改
const passwd = "Xx.191012";                   //登录密码  ⇦需要修改
